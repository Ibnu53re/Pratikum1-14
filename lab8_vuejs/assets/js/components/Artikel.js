const Artikel = {
    template: `
        <div>
            ...
            <button @click="tambah" style="margin-bottom:15px; padding:10px 15px;">Tambah Data</button>

            <div class="modal" v-if="showForm">
                <div class="modal-content">
                    <span class="close" @click="showForm = false" style="float:right; cursor:pointer; font-size:24px;">×</span>
